...
#         freq, a, eps_1, eps_2, ks_true, ka_true, ke_true, s0_true = 1.26, 1, 0.25 + 0.1j, 1 + 1j, 0.0019, 0.0501, 0.0520, 0.0028
...
#         r = Mie(frequency=freq, radius=a, eps_p=eps_1, eps_b=eps_2)
#         print (r)
