...
#define __PYX_HAVE__pyrism__cython_iem__sigma
#define __PYX_HAVE_API__pyrism__cython_iem__sigma
/* Early includes */
#include <string.h>
#include <stdio.h>
...
#define __Pyx_MODULE_NAME "pyrism.cython_iem.sigma"
extern int __pyx_module_is_main_pyrism__cython_iem__sigma;
int __pyx_module_is_main_pyrism__cython_iem__sigma = 0;

/* Implementation of 'pyrism.cython_iem.sigma' */
...
/* "pyrism/cython_iem/sigma.pyx":11
...
static PyObject *__pyx_f_6pyrism_10cython_iem_5sigma_compute_sigma_nought(__Pyx_memviewslice __pyx_v_Ts, __Pyx_memviewslice __pyx_v_Wn, __Pyx_memviewslice __pyx_v_Ivv, __Pyx_memviewslice __pyx_v_Ihh, __Pyx_memviewslice __pyx_v_ShdwS, __Pyx_memviewslice __pyx_v_k, __Pyx_memviewslice __pyx_v_kz_iza, __Pyx_memviewslice __pyx_v_kz_vza, __Pyx_memviewslice __pyx_v_sigma) {
  Py_ssize_t __pyx_v_xmax;
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_index;
  double __pyx_v_sigmavv;
  double __pyx_v_sigmahh;
  double __pyx_v_a0;
  double __pyx_v_sigma2i;
  double __pyx_v_kz_xzai2;
  __Pyx_memviewslice __pyx_v_VV_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_HH_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("compute_sigma_nought", 0);

  /* "pyrism/cython_iem/sigma.pyx":14
 *                                 double[:] ShdwS, double[:] k, double[:] kz_iza, double[:] kz_vza, double[:] sigma):
 *     cdef:
 ...
 * 
 */
  __pyx_v_xmax = (__pyx_v_kz_iza.shape[0]);

  /* "pyrism/cython_iem/sigma.pyx":20
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_xmax); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "pyrism/cython_iem/sigma.pyx":21
 * 
 *     VV = np.zeros(xmax, dtype=np.double)
 *     HH = np.zeros(xmax, dtype=np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_xmax); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_double); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "pyrism/cython_iem/sigma.pyx":23
 *     HH = np.zeros(xmax, dtype=np.double)
 * 
 *     VV_view = VV             # <<<<<<<<<<<<<<
 *     HH_view = HH
 * 
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_VV, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 23, __pyx_L1_error)
  __pyx_v_VV_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pyrism/cython_iem/sigma.pyx":24
 * 
 *     VV_view = VV
 *     HH_view = HH             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_HH, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 24, __pyx_L1_error)
  __pyx_v_HH_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pyrism/cython_iem/sigma.pyx":26
 *     HH_view = HH
 * 
 *     sigmavv, sigmahh = 0.0, 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = 0.0;
  __pyx_t_8 = 0.0;
  __pyx_v_sigmavv = __pyx_t_7;
  __pyx_v_sigmahh = __pyx_t_8;

  /* "pyrism/cython_iem/sigma.pyx":28
 *     sigmavv, sigmahh = 0.0, 0.0
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "pyrism/cython_iem/sigma.pyx":29
 * 
 *     for i in range(xmax):
 *         sigma2i = pow(sigma[i], 2)             # <<<<<<<<<<<<<<
 *         kz_xzai2 = pow(kz_iza[i], 2) + pow(kz_vza[i], 2)
 ...
 */
    ...
    __pyx_t_4 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_sigma.data + __pyx_t_12 * __pyx_v_sigma.strides[0]) )))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyNumber_Power2(__pyx_t_4, __pyx_int_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_v_sigma2i = __pyx_t_8;

    /* "pyrism/cython_iem/sigma.pyx":30
 *     for i in range(xmax):
 *         sigma2i = pow(sigma[i], 2)
 *         kz_xzai2 = pow(kz_iza[i], 2) + pow(kz_vza[i], 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_13 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_kz_iza.shape[0];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_kz_iza.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    __pyx_t_5 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_kz_iza.data + __pyx_t_14 * __pyx_v_kz_iza.strides[0]) )))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_4 = __Pyx_PyNumber_Power2(__pyx_t_5, __pyx_int_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_15 = __pyx_v_i;
    __pyx_t_13 = -1;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_kz_vza.shape[0];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_kz_vza.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    __pyx_t_5 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_kz_vza.data + __pyx_t_15 * __pyx_v_kz_vza.strides[0]) )))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_3 = __Pyx_PyNumber_Power2(__pyx_t_5, __pyx_int_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_v_kz_xzai2 = __pyx_t_8;

    /* "pyrism/cython_iem/sigma.pyx":32
 *         kz_xzai2 = pow(kz_iza[i], 2) + pow(kz_vza[i], 2)
 * 
 *         for j in range(1, Ts[i] + 1):             # <<<<<<<<<<<<<<
 *             index = j - 1
 ...
 */
    ...
    __pyx_t_5 = __Pyx_PyInt_From_long(((*((int *) ( /* dim=0 */ (__pyx_v_Ts.data + __pyx_t_16 * __pyx_v_Ts.strides[0]) ))) + 1)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    ...
    __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_3, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    if (likely(PyList_CheckExact(__pyx_t_5)) || PyTuple_CheckExact(__pyx_t_5)) {
      ...
      __pyx_t_17 = -1; __pyx_t_3 = PyObject_GetIter(__pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 32, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_18 = Py_TYPE(__pyx_t_3)->tp_iternext; if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 32, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    for (;;) {
      if (likely(!__pyx_t_18)) {
        if (likely(PyList_CheckExact(__pyx_t_3))) {
          ...
          __pyx_t_5 = PyList_GET_ITEM(__pyx_t_3, __pyx_t_17); __Pyx_INCREF(__pyx_t_5); __pyx_t_17++; if (unlikely(0 < 0)) __PYX_ERR(0, 32, __pyx_L1_error)
          #else
          __pyx_t_5 = PySequence_ITEM(__pyx_t_3, __pyx_t_17); __pyx_t_17++; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          #endif
        } else {
          if (__pyx_t_17 >= PyTuple_GET_SIZE(__pyx_t_3)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_5 = PyTuple_GET_ITEM(__pyx_t_3, __pyx_t_17); __Pyx_INCREF(__pyx_t_5); __pyx_t_17++; if (unlikely(0 < 0)) __PYX_ERR(0, 32, __pyx_L1_error)
          #else
          __pyx_t_5 = PySequence_ITEM(__pyx_t_3, __pyx_t_17); __pyx_t_17++; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          #endif
      ...
      /* "pyrism/cython_iem/sigma.pyx":33
 * 
 *         for j in range(1, Ts[i] + 1):
 *             index = j - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_5 = __Pyx_PyInt_SubtractObjC(__pyx_v_j, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_19 = __Pyx_PyIndex_AsSsize_t(__pyx_t_5); if (unlikely((__pyx_t_19 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_v_index = __pyx_t_19;

      /* "pyrism/cython_iem/sigma.pyx":35
 *             index = j - 1
 * 
 *             a0 = Wn[i, index] / factorial(j) * pow(sigma[i], (2 * j))             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_13 = __Pyx_PyInt_As_int(__pyx_v_j); if (unlikely((__pyx_t_13 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 35, __pyx_L1_error)
      __pyx_t_5 = PyFloat_FromDouble(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Wn.data + __pyx_t_20 * __pyx_v_Wn.strides[0]) ) + __pyx_t_21 * __pyx_v_Wn.strides[1]) ))) / ((double)__pyx_f_6pyrism_10cython_iem_5auxil_factorial(__pyx_t_13)))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_22 = __pyx_v_i;
      __pyx_t_13 = -1;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_v_sigma.shape[0];
        if (unlikely(__pyx_t_22 < 0)) __pyx_t_13 = 0;
      } else if (unlikely(__pyx_t_22 >= __pyx_v_sigma.shape[0])) __pyx_t_13 = 0;
      if (unlikely(__pyx_t_13 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_13);
        __PYX_ERR(0, 35, __pyx_L1_error)
      }
      __pyx_t_4 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_sigma.data + __pyx_t_22 * __pyx_v_sigma.strides[0]) )))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_1 = PyNumber_Multiply(__pyx_int_2, __pyx_v_j); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_2 = __Pyx_PyNumber_Power2(__pyx_t_4, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyNumber_Multiply(__pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 35, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      ...
      /* "pyrism/cython_iem/sigma.pyx":37
 *             a0 = Wn[i, index] / factorial(j) * pow(sigma[i], (2 * j))
 * 
 *             sigmavv += pow(abs(Ivv[i, index]), 2) * a0             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_1 = PyFloat_FromDouble(__pyx_v_sigmavv); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_23 = __pyx_v_i;
      __pyx_t_24 = __pyx_v_index;
      __pyx_t_13 = -1;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_v_Ivv.shape[0];
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_13 = 0;
      } else if (unlikely(__pyx_t_23 >= __pyx_v_Ivv.shape[0])) __pyx_t_13 = 0;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_v_Ivv.shape[1];
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_13 = 1;
      } else if (unlikely(__pyx_t_24 >= __pyx_v_Ivv.shape[1])) __pyx_t_13 = 1;
      if (unlikely(__pyx_t_13 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_13);
        __PYX_ERR(0, 37, __pyx_L1_error)
      }
      __pyx_t_2 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Ivv.data + __pyx_t_23 * __pyx_v_Ivv.strides[0]) ) + __pyx_t_24 * __pyx_v_Ivv.strides[1]) ))))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_5 = __Pyx_PyNumber_Power2(__pyx_t_2, __pyx_int_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = PyFloat_FromDouble(__pyx_v_a0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_4 = PyNumber_Multiply(__pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = PyNumber_InPlaceAdd(__pyx_t_1, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_2); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_v_sigmavv = __pyx_t_8;

      /* "pyrism/cython_iem/sigma.pyx":38
 * 
 *             sigmavv += pow(abs(Ivv[i, index]), 2) * a0
 *             sigmahh += pow(abs(Ihh[i, index]), 2) * a0             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_2 = PyFloat_FromDouble(__pyx_v_sigmahh); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_25 = __pyx_v_i;
      __pyx_t_26 = __pyx_v_index;
      __pyx_t_13 = -1;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_Ihh.shape[0];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_13 = 0;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_Ihh.shape[0])) __pyx_t_13 = 0;
      if (__pyx_t_26 < 0) {
        __pyx_t_26 += __pyx_v_Ihh.shape[1];
        if (unlikely(__pyx_t_26 < 0)) __pyx_t_13 = 1;
      } else if (unlikely(__pyx_t_26 >= __pyx_v_Ihh.shape[1])) __pyx_t_13 = 1;
      if (unlikely(__pyx_t_13 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_13);
        __PYX_ERR(0, 38, __pyx_L1_error)
      }
      __pyx_t_4 = PyFloat_FromDouble(__Pyx_c_abs_double((*((__pyx_t_double_complex *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Ihh.data + __pyx_t_25 * __pyx_v_Ihh.strides[0]) ) + __pyx_t_26 * __pyx_v_Ihh.strides[1]) ))))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_1 = __Pyx_PyNumber_Power2(__pyx_t_4, __pyx_int_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = PyFloat_FromDouble(__pyx_v_a0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_5 = PyNumber_Multiply(__pyx_t_1, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = PyNumber_InPlaceAdd(__pyx_t_2, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_4); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_v_sigmahh = __pyx_t_8;
 ...
 */
    ...
    /* "pyrism/cython_iem/sigma.pyx":40
 *             sigmahh += pow(abs(Ihh[i, index]), 2) * a0
 * 
 *         VV_view[i] = sigmavv * ShdwS[i] * pow(k[i], 2) / 2 * np.exp(-sigma2i * kz_xzai2)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __pyx_t_13 = -1;
    if (__pyx_t_27 < 0) {
      __pyx_t_27 += __pyx_v_ShdwS.shape[0];
      if (unlikely(__pyx_t_27 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_27 >= __pyx_v_ShdwS.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 40, __pyx_L1_error)
    }
    __pyx_t_3 = PyFloat_FromDouble((__pyx_v_sigmavv * (*((double *) ( /* dim=0 */ (__pyx_v_ShdwS.data + __pyx_t_27 * __pyx_v_ShdwS.strides[0]) ))))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_28 = __pyx_v_i;
    __pyx_t_13 = -1;
    if (__pyx_t_28 < 0) {
      __pyx_t_28 += __pyx_v_k.shape[0];
      if (unlikely(__pyx_t_28 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_28 >= __pyx_v_k.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 40, __pyx_L1_error)
    }
    __pyx_t_4 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_k.data + __pyx_t_28 * __pyx_v_k.strides[0]) )))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyNumber_Power2(__pyx_t_4, __pyx_int_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyInt_TrueDivideObjC(__pyx_t_4, __pyx_int_2, 2, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_exp); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyFloat_FromDouble(((-__pyx_v_sigma2i) * __pyx_v_kz_xzai2)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_1 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyNumber_Multiply(__pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 40, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __pyx_t_13 = -1;
    if (__pyx_t_29 < 0) {
      __pyx_t_29 += __pyx_v_VV_view.shape[0];
      if (unlikely(__pyx_t_29 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_29 >= __pyx_v_VV_view.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 40, __pyx_L1_error)
    }
    *((double *) ( /* dim=0 */ (__pyx_v_VV_view.data + __pyx_t_29 * __pyx_v_VV_view.strides[0]) )) = __pyx_t_8;

    /* "pyrism/cython_iem/sigma.pyx":41
 * 
 *         VV_view[i] = sigmavv * ShdwS[i] * pow(k[i], 2) / 2 * np.exp(-sigma2i * kz_xzai2)
 *         HH_view[i] = sigmahh * ShdwS[i] * pow(k[i], 2) / 2 * np.exp(-sigma2i * kz_xzai2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_13 = -1;
    if (__pyx_t_30 < 0) {
      __pyx_t_30 += __pyx_v_ShdwS.shape[0];
      if (unlikely(__pyx_t_30 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_30 >= __pyx_v_ShdwS.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    __pyx_t_2 = PyFloat_FromDouble((__pyx_v_sigmahh * (*((double *) ( /* dim=0 */ (__pyx_v_ShdwS.data + __pyx_t_30 * __pyx_v_ShdwS.strides[0]) ))))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_31 = __pyx_v_i;
    __pyx_t_13 = -1;
    if (__pyx_t_31 < 0) {
      __pyx_t_31 += __pyx_v_k.shape[0];
      if (unlikely(__pyx_t_31 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_31 >= __pyx_v_k.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    __pyx_t_4 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_k.data + __pyx_t_31 * __pyx_v_k.strides[0]) )))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = __Pyx_PyNumber_Power2(__pyx_t_4, __pyx_int_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyInt_TrueDivideObjC(__pyx_t_4, __pyx_int_2, 2, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyFloat_FromDouble(((-__pyx_v_sigma2i) * __pyx_v_kz_xzai2)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = NULL;
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyNumber_Multiply(__pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_32 = __pyx_v_i;
    __pyx_t_13 = -1;
    if (__pyx_t_32 < 0) {
      __pyx_t_32 += __pyx_v_HH_view.shape[0];
      if (unlikely(__pyx_t_32 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_32 >= __pyx_v_HH_view.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 41, __pyx_L1_error)
    }
    *((double *) ( /* dim=0 */ (__pyx_v_HH_view.data + __pyx_t_32 * __pyx_v_HH_view.strides[0]) )) = __pyx_t_8;
  }

  /* "pyrism/cython_iem/sigma.pyx":43
 *         HH_view[i] = sigmahh * ShdwS[i] * pow(k[i], 2) / 2 * np.exp(-sigma2i * kz_xzai2)
 * 
 *     return VV, HH             # <<<<<<<<<<<<<<
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_v_VV);
 ...
 */
  ...
  __Pyx_AddTraceback("pyrism.cython_iem.sigma.compute_sigma_nought", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_VV_view, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_HH_view, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pyrism.cython_iem.sigma.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyrism.cython_iem.sigma.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyrism.cython_iem.sigma.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyrism.cython_iem.sigma._memoryviewslice", /*tp_name*/
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("sigma", __pyx_methods, __pyx_k_Created_on_02_03_2019_by_Ismail, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyrism__cython_iem__sigma) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyrism.cython_iem.sigma")) {
      if (unlikely(PyDict_SetItemString(modules, "pyrism.cython_iem.sigma", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyrism.cython_iem.sigma", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyrism.cython_iem.sigma");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
