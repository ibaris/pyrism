...
#define __PYX_HAVE__pyrism__cython_iem__rspectrum
#define __PYX_HAVE_API__pyrism__cython_iem__rspectrum
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "pyrism/cython_iem/rspectrum.pyx",
  "__init__.pxd",
  "stringsource",
  "type.pxd",
};
...
static int (*__pyx_f_6pyrism_10cython_iem_5auxil_factorial)(int); /*proto*/
...
#define __Pyx_MODULE_NAME "pyrism.cython_iem.rspectrum"
extern int __pyx_module_is_main_pyrism__cython_iem__rspectrum;
int __pyx_module_is_main_pyrism__cython_iem__rspectrum = 0;

/* Implementation of 'pyrism.cython_iem.rspectrum' */
...
/* "pyrism/cython_iem/rspectrum.pyx":12
...
static __Pyx_memviewslice __pyx_f_6pyrism_10cython_iem_9rspectrum_compute_wvnb(__Pyx_memviewslice __pyx_v_iza, __Pyx_memviewslice __pyx_v_vza, __Pyx_memviewslice __pyx_v_raa, __Pyx_memviewslice __pyx_v_phi, __Pyx_memviewslice __pyx_v_k) {
  Py_ssize_t __pyx_v_xmax;
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_wvnb_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_sin_vza;
  double __pyx_v_sin_iza;
  double __pyx_v_cos_raa;
  double __pyx_v_cos_phi;
  double __pyx_v_sin_raa;
  double __pyx_v_sin_phi;
  double __pyx_v_part1;
  double __pyx_v_part2;
  PyObject *__pyx_v_wvnb = NULL;
  ...
  __Pyx_RefNannySetupContext("compute_wvnb", 0);

  /* "pyrism/cython_iem/rspectrum.pyx":14
 * cdef double[:] compute_wvnb(double[:] iza, double[:] vza, double[:] raa, double[:] phi, double[:] k):
 *     cdef:
 *         Py_ssize_t xmax = iza.shape[0]             # <<<<<<<<<<<<<<
 *         Py_ssize_t i
 ...
 */
  ...
  /* "pyrism/cython_iem/rspectrum.pyx":20
 * 
 * 
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_iza, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_double); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 20, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_wvnb = __pyx_t_5;
  __pyx_t_5 = 0;

  /* "pyrism/cython_iem/rspectrum.pyx":21
 * 
 *     wvnb = np.zeros_like(iza, dtype=np.double)
 *     wvnb_view = wvnb             # <<<<<<<<<<<<<<
 * 
 *     for i in range(xmax):
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_wvnb, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_v_wvnb_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pyrism/cython_iem/rspectrum.pyx":23
 *     wvnb_view = wvnb
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 *         sin_vza = sin(vza[i])
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "pyrism/cython_iem/rspectrum.pyx":24
 * 
 *     for i in range(xmax):
 *         sin_vza = sin(vza[i])             # <<<<<<<<<<<<<<
 *         cos_raa = cos(raa[i])
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_vza.shape[0];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_10 >= __pyx_v_vza.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 24, __pyx_L1_error)
    }
    __pyx_v_sin_vza = sin((*((double *) ( /* dim=0 */ (__pyx_v_vza.data + __pyx_t_10 * __pyx_v_vza.strides[0]) ))));

    /* "pyrism/cython_iem/rspectrum.pyx":25
 *     for i in range(xmax):
 *         sin_vza = sin(vza[i])
 *         cos_raa = cos(raa[i])             # <<<<<<<<<<<<<<
 *         sin_iza = sin(iza[i])
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_raa.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_raa.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 25, __pyx_L1_error)
    }
    __pyx_v_cos_raa = cos((*((double *) ( /* dim=0 */ (__pyx_v_raa.data + __pyx_t_12 * __pyx_v_raa.strides[0]) ))));

    /* "pyrism/cython_iem/rspectrum.pyx":26
 *         sin_vza = sin(vza[i])
 *         cos_raa = cos(raa[i])
 *         sin_iza = sin(iza[i])             # <<<<<<<<<<<<<<
 *         cos_phi = cos(phi[i])
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_v_iza.shape[0];
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_iza.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 26, __pyx_L1_error)
    }
    __pyx_v_sin_iza = sin((*((double *) ( /* dim=0 */ (__pyx_v_iza.data + __pyx_t_13 * __pyx_v_iza.strides[0]) ))));

    /* "pyrism/cython_iem/rspectrum.pyx":27
 *         cos_raa = cos(raa[i])
 *         sin_iza = sin(iza[i])
 *         cos_phi = cos(phi[i])             # <<<<<<<<<<<<<<
 *         sin_raa = sin(raa[i])
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_phi.shape[0];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_phi.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 27, __pyx_L1_error)
    }
    __pyx_v_cos_phi = cos((*((double *) ( /* dim=0 */ (__pyx_v_phi.data + __pyx_t_14 * __pyx_v_phi.strides[0]) ))));

    /* "pyrism/cython_iem/rspectrum.pyx":28
 *         sin_iza = sin(iza[i])
 *         cos_phi = cos(phi[i])
 *         sin_raa = sin(raa[i])             # <<<<<<<<<<<<<<
 *         sin_phi = sin(phi[i])
 ...
 */
    ...
    } else if (unlikely(__pyx_t_15 >= __pyx_v_raa.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 28, __pyx_L1_error)
    }
    __pyx_v_sin_raa = sin((*((double *) ( /* dim=0 */ (__pyx_v_raa.data + __pyx_t_15 * __pyx_v_raa.strides[0]) ))));

    /* "pyrism/cython_iem/rspectrum.pyx":29
 *         cos_phi = cos(phi[i])
 *         sin_raa = sin(raa[i])
 *         sin_phi = sin(phi[i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    } else if (unlikely(__pyx_t_16 >= __pyx_v_phi.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 29, __pyx_L1_error)
    }
    __pyx_v_sin_phi = sin((*((double *) ( /* dim=0 */ (__pyx_v_phi.data + __pyx_t_16 * __pyx_v_phi.strides[0]) ))));

    /* "pyrism/cython_iem/rspectrum.pyx":31
 *         sin_phi = sin(phi[i])
 * 
 *         part1 = pow((sin_vza * cos_raa - sin_iza * cos_phi), 2)             # <<<<<<<<<<<<<<
 ...
 * 
 */
    __pyx_v_part1 = pow(((__pyx_v_sin_vza * __pyx_v_cos_raa) - (__pyx_v_sin_iza * __pyx_v_cos_phi)), 2.0);

    /* "pyrism/cython_iem/rspectrum.pyx":32
 * 
 *         part1 = pow((sin_vza * cos_raa - sin_iza * cos_phi), 2)
 *         part2 = pow((sin_vza * sin_raa - sin_iza * sin_phi), 2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_part2 = pow(((__pyx_v_sin_vza * __pyx_v_sin_raa) - (__pyx_v_sin_iza * __pyx_v_sin_phi)), 2.0);

    /* "pyrism/cython_iem/rspectrum.pyx":34
 *         part2 = pow((sin_vza * sin_raa - sin_iza * sin_phi), 2)
 * 
 *         wvnb_view[i] = k[i] * sqrt(part1 + part2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_17 < 0) {
      __pyx_t_17 += __pyx_v_k.shape[0];
      if (unlikely(__pyx_t_17 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_k.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_18 < 0) {
      __pyx_t_18 += __pyx_v_wvnb_view.shape[0];
      if (unlikely(__pyx_t_18 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_18 >= __pyx_v_wvnb_view.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 34, __pyx_L1_error)
    }
    *((double *) ( /* dim=0 */ (__pyx_v_wvnb_view.data + __pyx_t_18 * __pyx_v_wvnb_view.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_k.data + __pyx_t_17 * __pyx_v_k.strides[0]) ))) * sqrt((__pyx_v_part1 + __pyx_v_part2)));
  }

  /* "pyrism/cython_iem/rspectrum.pyx":36
 *         wvnb_view[i] = k[i] * sqrt(part1 + part2)
 * 
 *     return wvnb             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_wvnb, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 36, __pyx_L1_error)
  __pyx_r = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("pyrism.cython_iem.rspectrum.compute_wvnb", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __pyx_L2:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_wvnb_view, 1);
  __Pyx_XDECREF(__pyx_v_wvnb);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "pyrism/cython_iem/rspectrum.pyx":38
 *     return wvnb
 * 
 * cdef int[:] compute_TS(double[:] iza, double[:] vza, double[:] sigma, double[:] k):             # <<<<<<<<<<<<<<
 *     cdef:
...
static __Pyx_memviewslice __pyx_f_6pyrism_10cython_iem_9rspectrum_compute_TS(__Pyx_memviewslice __pyx_v_iza, __Pyx_memviewslice __pyx_v_vza, __Pyx_memviewslice __pyx_v_sigma, __Pyx_memviewslice __pyx_v_k) {
  Py_ssize_t __pyx_v_xmax;
  Py_ssize_t __pyx_v_i;
  ...
  Py_ssize_t __pyx_t_15;
  Py_ssize_t __pyx_t_16;
  __Pyx_RefNannySetupContext("compute_TS", 0);

  /* "pyrism/cython_iem/rspectrum.pyx":40
 * cdef int[:] compute_TS(double[:] iza, double[:] vza, double[:] sigma, double[:] k):
 *     cdef:
 *         Py_ssize_t xmax = iza.shape[0]             # <<<<<<<<<<<<<<
 *         Py_ssize_t i
 ...
 */
  ...
  /* "pyrism/cython_iem/rspectrum.pyx":46
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_iza, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_intc); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "pyrism/cython_iem/rspectrum.pyx":47
 * 
 *     TS = np.zeros_like(iza, dtype=np.intc)
 *     TS_view = TS             # <<<<<<<<<<<<<<
 * 
 *     for i in range(xmax):
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_TS, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 47, __pyx_L1_error)
  __pyx_v_TS_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "pyrism/cython_iem/rspectrum.pyx":49
 *     TS_view = TS
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 *         mui = cos(iza[i])
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "pyrism/cython_iem/rspectrum.pyx":50
 * 
 *     for i in range(xmax):
 *         mui = cos(iza[i])             # <<<<<<<<<<<<<<
 *         muv = cos(vza[i])
 ...
 */
    ...
    /* "pyrism/cython_iem/rspectrum.pyx":51
 *     for i in range(xmax):
 *         mui = cos(iza[i])
 *         muv = cos(vza[i])             # <<<<<<<<<<<<<<
 *         TS_temp = 1
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_vza.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_vza.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 51, __pyx_L1_error)
    }
    __pyx_v_muv = cos((*((double *) ( /* dim=0 */ (__pyx_v_vza.data + __pyx_t_12 * __pyx_v_vza.strides[0]) ))));

    /* "pyrism/cython_iem/rspectrum.pyx":52
 *         mui = cos(iza[i])
 *         muv = cos(vza[i])
 *         TS_temp = 1             # <<<<<<<<<<<<<<
 *         error = 1.0
 ...
 */
    ...
    /* "pyrism/cython_iem/rspectrum.pyx":53
 *         muv = cos(vza[i])
 *         TS_temp = 1
 *         error = 1.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pyrism/cython_iem/rspectrum.pyx":55
 *         error = 1.0
 * 
 *         while error > 1.0e-8: # and TS_temp <= 150:             # <<<<<<<<<<<<<<
 *             TS_temp += 1
 ...
 */
    while (1) {
      __pyx_t_13 = ((__pyx_v_error > 1.0e-8) != 0);
      if (!__pyx_t_13) break;

      /* "pyrism/cython_iem/rspectrum.pyx":56
 * 
 *         while error > 1.0e-8: # and TS_temp <= 150:
 *             TS_temp += 1             # <<<<<<<<<<<<<<
 *             error = pow(pow(k[i] * sigma[i], 2) * pow((mui + muv), 2), TS_temp) / factorial(TS_temp)
 ...
 */
      ...
      /* "pyrism/cython_iem/rspectrum.pyx":57
 *         while error > 1.0e-8: # and TS_temp <= 150:
 *             TS_temp += 1
 *             error = pow(pow(k[i] * sigma[i], 2) * pow((mui + muv), 2), TS_temp) / factorial(TS_temp)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_11 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_k.shape[0];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_11 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_k.shape[0])) __pyx_t_11 = 0;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
      ...
      __pyx_t_11 = -1;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_sigma.shape[0];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_11 = 0;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_sigma.shape[0])) __pyx_t_11 = 0;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
        __PYX_ERR(0, 57, __pyx_L1_error)
      }
      __pyx_v_error = (pow((pow(((*((double *) ( /* dim=0 */ (__pyx_v_k.data + __pyx_t_14 * __pyx_v_k.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_sigma.data + __pyx_t_15 * __pyx_v_sigma.strides[0]) )))), 2.0) * pow((__pyx_v_mui + __pyx_v_muv), 2.0)), __pyx_v_TS_temp) / ((double)__pyx_f_6pyrism_10cython_iem_5auxil_factorial(__pyx_v_TS_temp)));
    }

    /* "pyrism/cython_iem/rspectrum.pyx":59
 *             error = pow(pow(k[i] * sigma[i], 2) * pow((mui + muv), 2), TS_temp) / factorial(TS_temp)
 * 
 *         TS_view[i] = TS_temp             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_11 = -1;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_v_TS_view.shape[0];
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_16 >= __pyx_v_TS_view.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 59, __pyx_L1_error)
    }
    *((int *) ( /* dim=0 */ (__pyx_v_TS_view.data + __pyx_t_16 * __pyx_v_TS_view.strides[0]) )) = __pyx_v_TS_temp;
  }

  /* "pyrism/cython_iem/rspectrum.pyx":61
 *         TS_view[i] = TS_temp
 * 
 *     return TS             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_TS, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 61, __pyx_L1_error)
  __pyx_r = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("pyrism.cython_iem.rspectrum.compute_TS", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
/* "pyrism/cython_iem/rspectrum.pyx":63
 *     return TS
 * 
 * cdef tuple compute_Wn_rss(corrfunc, double[:] iza, double[:] vza, double[:] raa, double[:] phi, double[:] k,             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_f_6pyrism_10cython_iem_9rspectrum_compute_Wn_rss(PyObject *__pyx_v_corrfunc, __Pyx_memviewslice __pyx_v_iza, __Pyx_memviewslice __pyx_v_vza, __Pyx_memviewslice __pyx_v_raa, __Pyx_memviewslice __pyx_v_phi, __Pyx_memviewslice __pyx_v_k, __Pyx_memviewslice __pyx_v_sigma, __Pyx_memviewslice __pyx_v_corrlength, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_n) {
  Py_ssize_t __pyx_v_xmax;
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_j;
  double __pyx_v_rss_temp;
  __Pyx_memviewslice __pyx_v_Wn_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_rss_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_wvnb = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_Wn_temp = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("compute_Wn_rss", 0);

  /* "pyrism/cython_iem/rspectrum.pyx":66
 *                           double[:] sigma, double[:] corrlength, int[:] n):
 *     cdef:
 *         Py_ssize_t xmax = iza.shape[0]             # <<<<<<<<<<<<<<
 *         Py_ssize_t i, j
 ...
 */
  ...
  /* "pyrism/cython_iem/rspectrum.pyx":74
 *         int[:] Ts
 * 
 ...
 * 
 */
  __pyx_t_1 = __pyx_f_6pyrism_10cython_iem_9rspectrum_compute_wvnb(__pyx_v_iza, __pyx_v_vza, __pyx_v_raa, __pyx_v_phi, __pyx_v_k); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 74, __pyx_L1_error)
  __pyx_v_wvnb = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "pyrism/cython_iem/rspectrum.pyx":75
 * 
 *     wvnb = compute_wvnb(iza=iza, vza=vza, raa=raa, phi=phi, k=k)
 *     Ts = compute_TS(iza=iza, vza=vza, sigma=sigma, k=k)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __pyx_f_6pyrism_10cython_iem_9rspectrum_compute_TS(__pyx_v_iza, __pyx_v_vza, __pyx_v_sigma, __pyx_v_k); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 75, __pyx_L1_error)
  __pyx_v_Ts = __pyx_t_2;
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;

  /* "pyrism/cython_iem/rspectrum.pyx":77
 *     Ts = compute_TS(iza=iza, vza=vza, sigma=sigma, k=k)
 * 
 *     Wn = np.zeros((xmax, max(Ts.base)))             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_v_xmax); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __pyx_memoryview_fromslice(__pyx_v_Ts, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_base); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_CallOneArg(__pyx_builtin_max, __pyx_t_7); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_Wn = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "pyrism/cython_iem/rspectrum.pyx":78
 * 
 *     Wn = np.zeros((xmax, max(Ts.base)))
 *     rss = np.zeros_like(iza)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_iza, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 78, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = NULL;
  ...
  /* "pyrism/cython_iem/rspectrum.pyx":80
 *     rss = np.zeros_like(iza)
 * 
 *     Wn_view = Wn             # <<<<<<<<<<<<<<
 *     rss_view = rss
 * 
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_Wn, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 80, __pyx_L1_error)
  __pyx_v_Wn_view = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;

  /* "pyrism/cython_iem/rspectrum.pyx":81
 * 
 *     Wn_view = Wn
 *     rss_view = rss             # <<<<<<<<<<<<<<
 * 
 *     for i in range(xmax):
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_rss, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 81, __pyx_L1_error)
  __pyx_v_rss_view = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "pyrism/cython_iem/rspectrum.pyx":83
 *     rss_view = rss
 * 
 *     for i in range(xmax):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "pyrism/cython_iem/rspectrum.pyx":84
 * 
 *     for i in range(xmax):
 *         Wn_temp, rss_temp = corrfunc(sigma[i], corrlength[i], wvnb[i], Ts[i])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_13 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_sigma.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_sigma.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 84, __pyx_L1_error)
    }
    __pyx_t_7 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_sigma.data + __pyx_t_12 * __pyx_v_sigma.strides[0]) )))); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_14 = __pyx_v_i;
    __pyx_t_13 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_corrlength.shape[0];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_corrlength.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 84, __pyx_L1_error)
    }
    __pyx_t_5 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_corrlength.data + __pyx_t_14 * __pyx_v_corrlength.strides[0]) )))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_15 = __pyx_v_i;
    __pyx_t_13 = -1;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_wvnb.shape[0];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_wvnb.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 84, __pyx_L1_error)
    }
    __pyx_t_6 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_wvnb.data + __pyx_t_15 * __pyx_v_wvnb.strides[0]) )))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_16 = __pyx_v_i;
    __pyx_t_13 = -1;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_v_Ts.shape[0];
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_16 >= __pyx_v_Ts.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 84, __pyx_L1_error)
    }
    __pyx_t_4 = __Pyx_PyInt_From_int((*((int *) ( /* dim=0 */ (__pyx_v_Ts.data + __pyx_t_16 * __pyx_v_Ts.strides[0]) )))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_INCREF(__pyx_v_corrfunc);
    __pyx_t_17 = __pyx_v_corrfunc; __pyx_t_18 = NULL;
    __pyx_t_13 = 0;
    ...
    if (PyFunction_Check(__pyx_t_17)) {
      PyObject *__pyx_temp[5] = {__pyx_t_18, __pyx_t_7, __pyx_t_5, __pyx_t_6, __pyx_t_4};
      __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_17, __pyx_temp+1-__pyx_t_13, 4+__pyx_t_13); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 84, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_17)) {
      PyObject *__pyx_temp[5] = {__pyx_t_18, __pyx_t_7, __pyx_t_5, __pyx_t_6, __pyx_t_4};
      __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_17, __pyx_temp+1-__pyx_t_13, 4+__pyx_t_13); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 84, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_18); __pyx_t_18 = 0;
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    #endif
    {
      __pyx_t_19 = PyTuple_New(4+__pyx_t_13); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 84, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_19);
      if (__pyx_t_18) {
        __Pyx_GIVEREF(__pyx_t_18); PyTuple_SET_ITEM(__pyx_t_19, 0, __pyx_t_18); __pyx_t_18 = NULL;
      }
      __Pyx_GIVEREF(__pyx_t_7);
      PyTuple_SET_ITEM(__pyx_t_19, 0+__pyx_t_13, __pyx_t_7);
      __Pyx_GIVEREF(__pyx_t_5);
      PyTuple_SET_ITEM(__pyx_t_19, 1+__pyx_t_13, __pyx_t_5);
      __Pyx_GIVEREF(__pyx_t_6);
      PyTuple_SET_ITEM(__pyx_t_19, 2+__pyx_t_13, __pyx_t_6);
      __Pyx_GIVEREF(__pyx_t_4);
      PyTuple_SET_ITEM(__pyx_t_19, 3+__pyx_t_13, __pyx_t_4);
      __pyx_t_7 = 0;
      __pyx_t_5 = 0;
      __pyx_t_6 = 0;
      __pyx_t_4 = 0;
      __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_17, __pyx_t_19, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 84, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
    ...
    if ((likely(PyTuple_CheckExact(__pyx_t_3))) || (PyList_CheckExact(__pyx_t_3))) {
      ...
      #else
      __pyx_t_17 = PySequence_ITEM(sequence, 0); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 84, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_17);
      __pyx_t_19 = PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_19)) __PYX_ERR(0, 84, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_19);
      #endif
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    } else {
      ...
      index = 0; __pyx_t_17 = __pyx_t_20(__pyx_t_4); if (unlikely(!__pyx_t_17)) goto __pyx_L5_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_17);
      index = 1; __pyx_t_19 = __pyx_t_20(__pyx_t_4); if (unlikely(!__pyx_t_19)) goto __pyx_L5_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_19);
      if (__Pyx_IternextUnpackEndCheck(__pyx_t_20(__pyx_t_4), 2) < 0) __PYX_ERR(0, 84, __pyx_L1_error)
      __pyx_t_20 = NULL;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_17, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
    __pyx_t_21 = __pyx_PyFloat_AsDouble(__pyx_t_19); if (unlikely((__pyx_t_21 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 84, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_19); __pyx_t_19 = 0;
    __PYX_XDEC_MEMVIEW(&__pyx_v_Wn_temp, 1);
    __pyx_v_Wn_temp = __pyx_t_1;
    __pyx_t_1.memview = NULL;
    __pyx_t_1.data = NULL;
    __pyx_v_rss_temp = __pyx_t_21;

    /* "pyrism/cython_iem/rspectrum.pyx":86
 *         Wn_temp, rss_temp = corrfunc(sigma[i], corrlength[i], wvnb[i], Ts[i])
 * 
 *         for j in range(Wn_temp.shape[0]):             # <<<<<<<<<<<<<<
 ...
 * 
 */
    __pyx_t_22 = (__pyx_v_Wn_temp.shape[0]);
    __pyx_t_23 = __pyx_t_22;
    for (__pyx_t_24 = 0; __pyx_t_24 < __pyx_t_23; __pyx_t_24+=1) {
      __pyx_v_j = __pyx_t_24;

      /* "pyrism/cython_iem/rspectrum.pyx":87
 * 
 *         for j in range(Wn_temp.shape[0]):
 *             Wn_view[i, j] = Wn_temp[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_13 = -1;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_Wn_temp.shape[0];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_13 = 0;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_Wn_temp.shape[0])) __pyx_t_13 = 0;
      if (unlikely(__pyx_t_13 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_13);
      ...
      __pyx_t_13 = -1;
      if (__pyx_t_26 < 0) {
        __pyx_t_26 += __pyx_v_Wn_view.shape[0];
        if (unlikely(__pyx_t_26 < 0)) __pyx_t_13 = 0;
      } else if (unlikely(__pyx_t_26 >= __pyx_v_Wn_view.shape[0])) __pyx_t_13 = 0;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_v_Wn_view.shape[1];
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_13 = 1;
      } else if (unlikely(__pyx_t_27 >= __pyx_v_Wn_view.shape[1])) __pyx_t_13 = 1;
      if (unlikely(__pyx_t_13 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_13);
        __PYX_ERR(0, 87, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_Wn_view.data + __pyx_t_26 * __pyx_v_Wn_view.strides[0]) ) + __pyx_t_27 * __pyx_v_Wn_view.strides[1]) )) = (*((double *) ( /* dim=0 */ (__pyx_v_Wn_temp.data + __pyx_t_25 * __pyx_v_Wn_temp.strides[0]) )));
    }

    /* "pyrism/cython_iem/rspectrum.pyx":89
 *             Wn_view[i, j] = Wn_temp[j]
 * 
 *         rss_view[i] = rss_temp             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_13 = -1;
    if (__pyx_t_28 < 0) {
      __pyx_t_28 += __pyx_v_rss_view.shape[0];
      if (unlikely(__pyx_t_28 < 0)) __pyx_t_13 = 0;
    } else if (unlikely(__pyx_t_28 >= __pyx_v_rss_view.shape[0])) __pyx_t_13 = 0;
    if (unlikely(__pyx_t_13 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_13);
      __PYX_ERR(0, 89, __pyx_L1_error)
    }
    *((double *) ( /* dim=0 */ (__pyx_v_rss_view.data + __pyx_t_28 * __pyx_v_rss_view.strides[0]) )) = __pyx_v_rss_temp;
  }

  /* "pyrism/cython_iem/rspectrum.pyx":91
 *         rss_view[i] = rss_temp
 * 
 *     return Wn, rss             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_INCREF(__pyx_v_Wn);
  __Pyx_GIVEREF(__pyx_v_Wn);
  PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_v_Wn);
  __Pyx_INCREF(__pyx_v_rss);
  __Pyx_GIVEREF(__pyx_v_rss);
  PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_v_rss);
 ...
 */
  ...
  __Pyx_AddTraceback("pyrism.cython_iem.rspectrum.compute_Wn_rss", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_Wn_view, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_rss_view, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pyrism.cython_iem.rspectrum.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyrism.cython_iem.rspectrum.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyrism.cython_iem.rspectrum.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyrism.cython_iem.rspectrum._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_rspectrum(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_rspectrum},
  {0, NULL}
};
#endif
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  if (__Pyx_ImportFunction(__pyx_t_1, "factorial", (void (**)(void))&__pyx_f_6pyrism_10cython_iem_5auxil_factorial, "int (int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initrspectrum(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initrspectrum(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_rspectrum(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_rspectrum(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_rspectrum(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'rspectrum' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_rspectrum(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("rspectrum", __pyx_methods, __pyx_k_Created_on_02_01_2019_by_Ismail, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyrism__cython_iem__rspectrum) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyrism.cython_iem.rspectrum")) {
      if (unlikely(PyDict_SetItemString(modules, "pyrism.cython_iem.rspectrum", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pyrism/cython_iem/rspectrum.pyx":7
 * """
 ...
 */
  ...
  /* "pyrism/cython_iem/rspectrum.pyx":1
 * # -*- coding: utf-8 -*-             # <<<<<<<<<<<<<<
 * # cython: cdivision=True
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyrism.cython_iem.rspectrum", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyrism.cython_iem.rspectrum");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
